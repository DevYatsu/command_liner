...
get_command = Command("get", "A command to perform a get request easily.").add_params("url", "file_name").set_script('''
import requests
r = requests.get("+++")
data = r.json()
...
def generate_sh_script():
    ...
    with open(script_path, "w") as script_file:
        ...
        script_file.write(f'python {os.getcwd()}/main.py "$@"\\n')
...
commands = list([create_command, remove_command, rename_command,
                 get_command, write_command, generate_sh_command])
