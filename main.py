...
write_command = Command("write", "A command for writing content to a file").set_help(f"To run the command:\n\t* {commands_prefix} write <file to write> <content> (<mode for writing>)").add_params("file_name", "content").add_optional_parameter("mode").set_script('''
file_name = "+++"
content = "+++"
mode = "+++"
