...
def generate_sh_script():  
    ...
    with open(shell_script_path, "w") as script_file:
        ...
        script_file.write('python ./main.py "$@"\\n')
    ...
    if platform.system() == "Windows":
        symbolic_link_dir = os.path.expanduser("~/AppData/Local/Programs/{commands_prefix}")
    else: 
        symbolic_link_path = os.path.join("/usr/local/bin/", "{commands_prefix}")
